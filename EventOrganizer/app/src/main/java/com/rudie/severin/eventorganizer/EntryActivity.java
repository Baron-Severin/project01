...
import com.rudie.severin.eventorganizer.UtilityClasses.EntryAdapter;
...
public class EntryActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.ENTRY_LISTVIEW);

        entryAdapter = new EntryAdapter(mContext, CardHolder.currentDetail);
        if (listView != null) {
...
//        editList = Arrays.asList(tempArray);
    ...
    private ArrayList<String> collectText() {
        ...
        List<EditText> editTextList = CardHolder.getInstance().getCurrentEntryEditTexts();
